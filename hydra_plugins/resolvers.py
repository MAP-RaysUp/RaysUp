...
def get_feature(target: str) -> int:
    ...
    if "vits" in model_name or "vit_small" in model_name:
        return 384
    if "vit_pe_spatial_small" in model_name:
        return 384
    if "vit_pe_spatial_base" in model_name:
        return 768
    if "vit_pe_spatial_large" in model_name:
        return 1024
    if "vit_pe_spatial_gigantic" in model_name:
        return 1536
